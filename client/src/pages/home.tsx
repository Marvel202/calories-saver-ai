          ...
          <div className="max-w-6xl mx-auto w-full">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl md:text-2xl text-gray-700 mb-12 max-w-3xl mx-auto leading-relaxed font-medium">
                Upload a photo of your meal and get instant macronutrient breakdown <a href="#methodology" className="text-primary underline hover:text-primary/80">under fingertip</a> powered by AI. Track protein, carbs, and fat effortlessly.
              </p>
            </div>
