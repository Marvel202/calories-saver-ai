...
export function ExampleResults() {
  const examples = [
    {
      image:
        "https://images.unsplash.com/photo-1540420773420-3366772f4999?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=400",
      title: "Greek Salad",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {examples.map((example, index) => (
            <div
              key={index}
              className="elevation-3 rounded-3xl overflow-hidden hover-lift"
              data-testid={`example-${index + 1}`}
            >
              <img
                src={example.image}
                alt={example.alt}
